#ifndef WIZARDS_QRCWIZARD_H
#define WIZARDS_QRCWIZARD_H
...
class QrcWizardDialog : public Core::BaseFileWizard
{
    Q_OBJECT

public:
    QrcWizardDialog(const Core::BaseFileWizardFactory *factory, QWidget *parent = 0);

    Utils::FileWizardPage* m_firstPage;
    ProjectExplorer::FolderNode* d_where;
};

class QrcWizardFactory : public Core::BaseFileWizardFactory
{
    Q_OBJECT
